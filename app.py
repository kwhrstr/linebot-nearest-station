...
def handle_location(event):
    ...
    # 最寄駅名から座標を取得
    near_location_url = 'https://maps.googleapis.com/maps/api/place/textsearch/xml?query={}&key={}'.format(near_station_list[0].text, 'AIzaSyDap2dQQx8T0SnMuHQ110Pp5mXDvnldXns');
